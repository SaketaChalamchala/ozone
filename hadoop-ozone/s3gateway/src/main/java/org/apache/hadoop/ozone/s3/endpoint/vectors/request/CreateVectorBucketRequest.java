...
import org.apache.hadoop.ozone.s3.endpoint.vectors.data.EncryptionConfiguration;

public class CreateVectorBucketRequest {

  @JsonProperty(value = "encryptionConfiguration", required = false)
  ...
  @JsonCreator
  public CreateVectorBucketRequest(
      @JsonProperty(value = "encryptionConfiguration", required = false) EncryptionConfiguration encryptionConfiguration,
